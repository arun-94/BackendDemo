...
public class ProductListQuery extends AsyncTask<String, Void, String>
{
    String temp;
    ...
    protected String doInBackground(String... params)
    {
        ...
        String url;
        url = "http://tisserindia.com/stores/mobileApi/mobileAPI.php?action=categoryDetails&id=" + categoryID;
