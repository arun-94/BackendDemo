...
public class AnimUtils
{
    ...
    public static void scaleIn(final View view, int durationMs, int startDelayMs)
    {
        AnimatorListenerAdapter listener = (new AnimatorListenerAdapter()
        {
            ...
            public void onAnimationCancel(Animator animation)
            {
                Log.d("Animation Cancelled", "Animation Cancelled");
                view.setScaleX(1);
                view.setScaleY(1);
            }
        });
    ...
    private static void scaleInternal(final View view, int startScaleValue, int endScaleValue, int durationMs, int startDelay, AnimatorListenerAdapter listener, Interpolator interpolator)
    {
        ...
        animator.setInterpolator(interpolator).scaleX(endScaleValue).scaleY(endScaleValue).setListener(listener).withLayer();
