...
public class ProductDetailQuery extends AsyncTask<String, Void, String>
{
    String temp;
    ...
    protected String doInBackground(String... params)
    {
        ...
        String url;
        url = "http://tisserindia.com/stores/mobileApi/mobileAPI.php?action=productDetails&id=" + productID;
